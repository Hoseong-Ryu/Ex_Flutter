    ...
    Widget titleSection = Container(
      ...
      child: Row(
        ...
        children: [
          ...
          // Text('41'),
          //endregion
          FavoriteWidget(),//stateful widget icon
        ],
      ),
    );
    //endregion
...
class FavoriteWidget extends StatefulWidget {//동적 위젯
  @override
  _FavoriteWidgetState createState() => _FavoriteWidgetState();// Stateful Widget 빌드하면 즉시 createState()가 호출
}
